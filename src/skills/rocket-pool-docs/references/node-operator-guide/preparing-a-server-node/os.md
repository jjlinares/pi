<!-- Source: https://docs.rocketpool.net/node-staking/vps/os -->
...
- Use at least **100 GiB** if you're just trying Rocket Pool out on the [Hoodi Test Network](../testnet/overview).
