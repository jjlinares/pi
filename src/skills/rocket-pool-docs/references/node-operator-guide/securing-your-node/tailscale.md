<!-- Source: https://docs.rocketpool.net/node-staking/tailscale -->
...
You may also remove access to the SSH port adding from the [enabling a firewall](/en/node-staking/securing-your-node#essential-enable-a-firewall) steps to completely lock down your node.
