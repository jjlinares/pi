<!-- Source: https://docs.rocketpool.net/node-staking/securing-your-node -->

---
next:
  text: "Tailscale"
  link: "/en/node-staking/tailscale"
---
...
<div className="p-3">
  <Tabs>
    ...
    <Tab label="Manually Adding the Key">
