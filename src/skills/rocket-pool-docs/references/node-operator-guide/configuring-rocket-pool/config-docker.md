<!-- Source: https://docs.rocketpool.net/node-staking/config-docker -->
...
<div className="p-3">
  <Tabs>
    <Tab label="Locally Managed">
      ...
      Please refer to the [Choosing your ETH clients](/en/node-staking/eth-clients#execution-clients) section for a description of each option.
        ...
        <Tabs>
          <Tab label="Lighthouse">
            ...
            **Note the maximum length of the graffiti is 16 characters.**
            ...
            To check if the QUIC configuration is working you should see a 2-digit number after `libp2p_quic_peers` when running `docker run --network rocketpool_net curlimages/curl http://eth2:9100/metrics | grep libp2p_peers_multi`.
...
Both the Hoodi Testnet and Mainnet are supported.
