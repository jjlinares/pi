<!-- Source: https://docs.rocketpool.net/node-staking/starting-rp -->
...
Commit-Boost client: Disabled
```

The first line will tell you if your Smartnode is configured for the Ethereum mainnet or for the Hoodi testnet.
  ...
  <Tabs>
    <Tab label="Docker (Default) Mode">
      ...
      <p className="rspress-directive warning">
        ...
        This is okay!
        The validator container will fail until a new validator has been created using the `rocketpool node deposit` command, which we will cover in the [Creating a Megapool Validator](/node-staking/megapools/create-megapool-validator) section.
