<!-- Source: https://docs.rocketpool.net/node-staking/wallet-init -->
...
This is simply an Execution Layer address that will hold your node's funds - it will use this to send ETH to your megapool validator when you begin staking, pay for gas during various transactions, and other various operations.
