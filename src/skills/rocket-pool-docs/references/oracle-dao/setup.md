<!-- Source: https://docs.rocketpool.net/odao/setup -->
...
The best way to start is by following [the standard setup instructions](../node-staking/platform) for a normal Rocket Pool node.
