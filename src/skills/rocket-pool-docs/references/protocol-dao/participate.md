<!-- Source: https://docs.rocketpool.net/pdao/participate -->
...
Please read the [lifecycle of a proposal](./pdao#lifecycle-of-a-pdao-proposal) before proceeding. It'll explain
...
Learn more about how this all works via: /en/pdao/participate#participating-in-on-chain-pdao-proposals
...
- If you respond with `delegate`, you'll have the opportunity to save a bit of gas by initializing voting
  and [setting a delegate](./participate#delegating-voting-power) within the same transaction.
...
- Included in snapshotting (either by [initializing voting](./participate#initializing-voting) or by
  registering post Houston)
- Must have at least one minipool
- Has non-zero voting power
- Has allowed [RPL locking](./participate#allowing-rpl-locking)
...
through the [governance](./participate#governance-process) process before a proposal is created on chain.
...
the [vote delay period](./pdao#vote-delay-period) upon creation.
...
<div className="p-3">
  <Tabs>
    <Tab label="Viewing a List of Proposals">
      ...
      [challengers](/en/pdao/pdao#challenge-process) can dispute the validity of the
      ...
      proposal](./pdao#lifecycle-of-a-pdao-proposal) for a refresher.
    </Tab>
