...
description: Design deep modules with small interfaces that hide complexity. Use when shaping interfaces, choosing seams, improving testability or code navigability, or applying the shared deep-module vocabulary.
---
